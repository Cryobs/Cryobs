...
**Systems & Infra**
`Linux` `Bash` `Docker` `Nginx` `Apache` `nftables` `AWS` `netplan` `systemd`

**Languages**
`Python` `C` `Assembly` `HTML/CSS/JS` `Java` `Flutter/Dart`
...
- 🏠 **[homelab](https://github.com/Cryobs/homelab)** - Self-hosted infrastructure on Raspberry PI
- 💾 **[fetcha](https://github.com/Cryobs/fetcha)** - Fast, small and easy configurated system info fetch.

---

## 📫 Contact

Open to junior DevOps roles, internships, or just interesting conversations about Linux and infrastructure.
